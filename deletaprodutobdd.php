    ...
    <div class="container">
        ...
        <main>
            <header class="row tm-welcome-section">
                <h2 class="col-12 text-center tm-section-title">Deletar Produtos</h2>
            ...
            <div class="form-register">
                <form method="POST" action="deleta.php">
                            ...
                            <input name="produto_id" type="number" placeholder="Verifique Bem o ID!">
                            <input id="s1" type="submit" value="Deletar Produto">
                </form>
            </div>
